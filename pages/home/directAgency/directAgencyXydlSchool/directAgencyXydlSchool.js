// pages/home/directAgency/directAgencyXydlSchool/directAgencySchool.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    var that=this;
      ...
      wx.setNavigationBarTitle({ title: that.data.schoolname })
  ...
  //排序：代理
  sortagent: function (e) {
    var that = this;
    var sortagent = Number(that.data.sortagent) + 1;
    // console.log(e.currentTarget.dataset.sortname)
    that.setData({
      sorttype: 0,
      sortdate: 0,
